...
def test_anna_sall_rdv():
    """Test de création d'un rendez-vous avec Anna Sall"""
    print("🔍 Test de création d'un rendez-vous avec Anna Sall")
    print("=" * 50)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Anna Sall a l'ID Patient 16 (pas l'ID User 42)
            patient_id = 16  # ID du profil Patient d'Anna Sall
            print(f"📋 Utilisation du patient Anna Sall - ID Patient: {patient_id}")
            ...
            rdv_data = {
                "patient": patient_id,  # ID du profil Patient (16)
                "service": service['id'],
                "docteur": doctor['id'],
                "date_confirmee": tomorrow.strftime("%Y-%m-%dT10:00:00"),
                "message": "Test de création de rendez-vous avec Anna Sall",
