...
interface ResponsiveHealthMetricCardProps {
  title: string;
  value: string | number;
  unit?: string;
  description?: string;
...
const ResponsiveHealthMetricCard: React.FC<ResponsiveHealthMetricCardProps> = ({
  title,
  value,
  unit,
  description,
  ...
  const getStatusBadge = () => {
    switch (status) {
      case 'normal':
        return { variant: 'default' as const, label: 'Normal', color: 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' };
      case 'warning':
        return { variant: 'secondary' as const, label: 'Attention', color: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' };
      case 'danger':
        return { variant: 'destructive' as const, label: 'Danger', color: 'bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200' };
      case 'critical':
...
export default ResponsiveHealthMetricCard;
