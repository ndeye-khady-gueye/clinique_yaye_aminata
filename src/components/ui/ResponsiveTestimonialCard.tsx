...
const ResponsiveTestimonialCard: React.FC<ResponsiveTestimonialCardProps> = ({
  name,
  role,
  company,
  content,
  ...
  return (
    <Card className={cn('card-responsive hover:shadow-lg transition-shadow', className)}>
      ...
      <CardContent className="p-4 sm:p-6 pt-0">
        ...
        <blockquote className="text-sm sm:text-base text-gray-700 dark:text-gray-300 italic leading-relaxed">
          "{content}"
        </blockquote>
      </CardContent>
    </Card>
